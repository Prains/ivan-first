...
import ArchiveBookingMobileList from "../ArchiveBookingMobileList/ArchiveBookingMobileList";
                ...
                user.userRole === "landlord" ?
                    ...
                    <>
                        <div className='py-[14px] px-[12px] bg-[#EBF8FF] mt-[18px] rounded-[6px] pb-[60px]'>
                            {books.map((book) => {
                                return (
                                    book.book.status === "resolved" && <ArchiveBookingMobileItem key={book.id} {...book} userRole={user.userRole} />
                                )
                            })
