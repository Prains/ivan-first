            ...
            <PopoverContent className='xl:w-[964px] lg:w-[650px] md:w-[500px] bg-[#0E1A30] text-[#FFFFFF]'>
                ...
                <PopoverBody  style={{backgroundImage: `url(${bannerVector.src})`}} className='bg-contain bg-[#0E1A30] rounded-[6px] bg-no-repeat md:flex md:gap-[74px] md:justify-between md:px-[70px] pb-[30px] md:pb-[100px] md:py-[30px]'>
                    <div className='flex-1'>
                        <div>
                            <h3 className='text-center mb-6 md:mb-0 md:text-[24px] text-[16px] hidden md:block'>Категории</h3>
                            <h3 className='text-center mb-6 md:mb-0 md:text-[24px] text-[16px] block md:hidden'>Фильтры</h3>

                        </div>
                        <div>
                            <h3 className='block mb-[16px] text-[16px] md:hidden'>Все категории</h3>
                            <ul className='flex flex-wrap gap-1 md:flex md:flex-col md:items-start md:list-disc md:mt-[27px]'>
                                <li className='bg-[#182A4A] md:bg-transparent px-4 py-2 md:py-0 md:px-0 rounded-[6px] md:mb-[24px] md:hover:underline decoration-2'><Link href='/'>Киностудии</Link></li>
                                <li className='bg-[#182A4A] md:bg-transparent px-4 py-2 md:py-0 md:px-0 rounded-[6px] md:mb-[24px] md:hover:underline decoration-2'><Link href='/'>Дизайн-студии</Link></li>
                                <li className='bg-[#182A4A] md:bg-transparent px-4 py-2 md:py-0 md:px-0 rounded-[6px] md:mb-[24px] md:hover:underline decoration-2'><Link href='/'>Книжные магазины</Link></li>
                                <li className='bg-[#182A4A] md:bg-transparent px-4 py-2 md:py-0 md:px-0 rounded-[6px] md:mb-[24px] md:hover:underline decoration-2'><Link href='/'>Киностудии</Link></li>
                                <li className='bg-[#182A4A] md:bg-transparent px-4 py-2 md:py-0 md:px-0 rounded-[6px] md:mb-[24px] md:hover:underline decoration-2'><Link href='/'>Киностудии</Link></li>
                                <li className='bg-[#182A4A] md:bg-transparent px-4 py-2 md:py-0 md:px-0 rounded-[6px] md:mb-[24px] md:hover:underline decoration-2'><Link href='/'>Киностудии</Link></li>
                                <li className='bg-[#182A4A] md:bg-transparent px-4 py-2 md:py-0 md:px-0 rounded-[6px] md:mb-[24px] md:hover:underline decoration-2'><Link href='/'>Киностудии</Link></li>
