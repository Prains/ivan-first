...
const Banner = () => {
    return (
        <section
            className='items-center justify-center relative bg-[#0C1622] bg-cover bg-no-repeat w-full h-[480px] md:flex hidden'>
            <div className='flex h-full justify-center md:gap-12 lg:gap-24 items-center md:max-w-[100%] lg:max-w-[90%] mx-auto relative'>
                ...
                <h1 className=' w-[439px] lg:top-40 md:top-40 md:right-0 lg:right-0 text-[#FFFFFF] md:text-[28px] lg:text-[32px] font-bold leading-[40px] z-5'>АГЕНСТВО
